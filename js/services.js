...
function showDetails(service) {
  ...
  function showDetails(service) {
    const serviceDetails = {
      ...
      'repair-services-1': {
        title: 'A1 Repair Services',
        description: 'Expert repair services for all kinds of electronics, including TVs, laptops, mobile phones, and household appliances.'
      },
      'warranty-support-2': {
        title: 'Warranty & Support',
        description: 'Comprehensive warranty and support for all our products, including extended warranties and dedicated support teams.'
      },
      'installation-bisce-3': {
        title: 'Installation Bisce',
        description: 'Professional installation services for all kinds of electronics, including home theaters, security systems, and office equipment.'
      }
    };
